 ...
 * Allows supervisors to override NBE compliance violations with justification
 */
...
import { ComplianceViolation } from "@/lib/utils/nbe-compliance";
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>
            This loan application has NBE compliance violations that require supervisor approval to proceed.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <Alert variant="destructive">
            ...
            <AlertDescription>
              <div className="font-semibold mb-2">Compliance Violations:</div>
          ...
          <Alert>
            <AlertTriangle className="h-4 w-4" />
            <AlertDescription>
              <strong>Warning:</strong> This override will be logged to the audit trail and may be subject to regulatory review. 
              Only proceed if you have valid business justification for the override.
            </AlertDescription>
          </Alert>
        </div>
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={isSubmitting || !overrideReason.trim() || overrideReason.trim().length < 20}
          >
