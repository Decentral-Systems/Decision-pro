...
export function CustomerJourneyInsightsWidget() {
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Customer journey stage distribution and conversion metrics
              </CardDescription>
            </div>
            <ApiStatusIndicator
            ...
            <AlertDescription className="flex items-center justify-between">
              <div>
                <span className="font-semibold">
                  Failed to load customer journey insights.
                </span>
  ...
  if (!insights || !insights.stages || insights.stages.length === 0) {
    ...
    if (statusCode === 404) {
      ...
      description =
        "The customer journey insights API endpoint is not available. Please check if the service is properly configured.";
      ...
      description =
        "The customer journey service is temporarily unavailable. Please try again in a few moments.";
    } else if (error) {
      title = "Failed to Load Data";
      description =
        "Unable to fetch customer journey insights. Please check your connection and try again.";
    } else {
      description =
        "No customer journey data is available. This may be due to insufficient data in the system.";
    }
  ...
  const totalCustomers =
    insights.metadata?.total_customers ||
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              {totalCustomers.toLocaleString()} total customers across journey
              stages
            </CardDescription>
          </div>
          <ApiStatusIndicator
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            {insights.stages.map((stage) => {
              ...
              const customerCount =
                (stage as any).customer_count || stage.customerCount || 0;
              const percentageOfTotal =
                (stage as any).percentage_of_total ??
                stage.percentageOfTotal ??
                0;
              const avgDuration =
                (stage as any).avg_duration_from_previous_stage_seconds ??
                stage.avgDurationFromPreviousStageSeconds;
          ...
          {((insights as any).conversion_funnel || insights.conversionFunnel) &&
            ((insights as any).conversion_funnel || insights.conversionFunnel)
              ...
              <div className="space-y-3 border-t pt-4">
                ...
                {(
                  (insights as any).conversion_funnel ||
                  ...
                  const conversionRate =
                    edge.conversion_rate ?? edge.conversionRate ?? 0;
