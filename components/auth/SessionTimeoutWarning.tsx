...
export function SessionTimeoutWarning() {
  const { showTimeoutWarning, timeoutRemaining, extendSession, logout } =
    useAuth();
      ...
      >
        ...
        <div className="py-6">
          ...
          <p className="mt-4 text-sm text-muted-foreground">
            Click &quot;Extend Session&quot; to continue working, or
            &quot;Logout&quot; to end your session now.
          </p>
        </div>
...
export function SessionTimeoutBanner() {
  ...
  return (
    <Alert
      className={cn(
        "fixed bottom-4 right-4 z-50 w-96 shadow-lg",
        urgencyLevel === "critical"
          ? "border-destructive bg-destructive/10"
          : "border-warning bg-warning/10"
      )}
      ...
      <AlertDescription className="flex items-center justify-between">
        <div className="flex-1">
          <p className="text-sm font-medium">
            Session expiring in {formatTimeRemaining(timeoutRemaining)}
          </p>
