          ...
          <AlertDescription>
            <div className="space-y-2">
              <div className="font-semibold">
                Active Incidents ({systemStatus.incidents.length})
              </div>
      ...
      {systemStatus && (
        <>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Target: 99.9% | Status:{" "}
                    {slaMetrics.uptime ? "Met" : "Breached"}
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Target: &lt;200ms | Status:{" "}
                    {slaMetrics.latency_p95 ? "Met" : "Breached"}
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Target: &lt;0.1% | Status:{" "}
                    {slaMetrics.error_rate ? "Met" : "Breached"}
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          {systemStatus.services &&
            Object.keys(systemStatus.services).length > 0 && (
              <DashboardSection
          ...
          {systemStatus.dependencies &&
            Object.keys(systemStatus.dependencies).length > 0 && (
              <DashboardSection
                title="Dependencies"
              ...
              >
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Status of infrastructure dependencies
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                      {Object.entries(systemStatus.dependencies || {}).map(
                        ([key, dependency]) => {
                          const depObj =
          ...
          {/* Synthetic Checks */}
          {systemStatus.synthetic_checks &&
            systemStatus.synthetic_checks.length > 0 && (
              <DashboardSection
              ...
              >
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      {systemStatus.synthetic_checks.map(
                        (check: any, idx: number) => (
                          ...
                          >
                            ...
                            <div className="flex items-center gap-2">
                              <Badge
                                variant={
                                  check.passed ? "default" : "destructive"
                                }
                              >
