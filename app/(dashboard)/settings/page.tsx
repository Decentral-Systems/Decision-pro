  ...
  const handleImport = () => {
    try {
      ...
      Object.keys(validated).forEach((key) => {
        setValue(key as any, validated[key as keyof SettingsFormData], { shouldDirty: true });
      });
    ...
    <div className="space-y-8">
      ...
      {error && !data && (
        <Alert variant="destructive">
          ...
          <AlertDescription className="flex items-center justify-between">
            <div>
              <span className="font-semibold">Failed to load settings from API.</span>
              <p className="text-sm mt-1 text-muted-foreground">
                Error: {(error as any)?.message || "Unknown error occurred"}
                {(error as any)?.statusCode && ` (Status: ${(error as any)?.statusCode})`}
              </p>
              <p className="text-xs mt-1 text-muted-foreground">
                Using default form values. Settings may not reflect current server configuration.
              </p>
            </div>
            <Button
              variant="outline"
      ...
      {!isLoading && !error && !data && (
        <Alert>
          ...
          <AlertDescription>
            No settings data found. The API returned an empty result. Using default form values.
          </AlertDescription>
        </Alert>
      )}
                  ...
                  <>
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        {data && (
                          <div className="flex items-center gap-2 text-xs text-muted-foreground">
                            ...
                            Current: {data.system?.auto_refresh_interval || defaultFormValues.system.auto_refresh_interval}
                            {watch("system.auto_refresh_interval") !== (data.system?.auto_refresh_interval || defaultFormValues.system.auto_refresh_interval) && (
                      ...
                      <Input
                        ...
                        type="number"
                        {...register("system.auto_refresh_interval", { valueAsNumber: true })}
                        disabled={!canEdit}
                      />
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value: "light" | "dark" | "system") =>
                          setValue("system.theme", value, { shouldDirty: true })
                        }
                      >
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          setValue("system.timezone", value, { shouldDirty: true })
                        }
                      >
          ...
          <TabsContent value="api" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>API client settings and caching options</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                {isLoading ? (
                  <Skeleton className="h-40" />
                  ...
                  <>
                    <div className="space-y-2">
                      ...
                      <Input
                        id="api_timeout"
                        type="number"
                        {...register("api.api_timeout", { valueAsNumber: true })}
                      />
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        id="retry_attempts"
                        type="number"
                        {...register("api.retry_attempts", { valueAsNumber: true })}
                      />
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          setValue("api.cache_enabled", checked, { shouldDirty: true })
                        }
                      />
                    </div>
                    ...
                    {cacheEnabled && (
                      <div className="space-y-2">
                        ...
                        <Input
                          id="cache_ttl"
                          type="number"
                          {...register("api.cache_ttl", { valueAsNumber: true })}
                        />
                  ...
                  <>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          setValue("notifications.notification_enabled", checked, { shouldDirty: true })
                        }
                      />
                    </div>
                    ...
                    <div className="border-t pt-4 space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            setValue("notifications.email_notifications", checked, { shouldDirty: true })
                          }
                        />
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            setValue("notifications.sms_notifications", checked, { shouldDirty: true })
                          }
                        />
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            setValue("notifications.push_notifications", checked, { shouldDirty: true })
                          }
                        />
                      </div>
                    </div>
                    ...
                    <div className="border-t pt-4 space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                          <Label htmlFor="credit_score_alerts">Credit Score Alerts</Label>
                          <p className="text-sm text-muted-foreground">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            setValue("notifications.credit_score_alerts", checked, { shouldDirty: true })
                          }
                        />
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            setValue("notifications.risk_alerts", checked, { shouldDirty: true })
                          }
                        />
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            setValue("notifications.compliance_alerts", checked, { shouldDirty: true })
                          }
                        />
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            setValue("notifications.system_alerts", checked, { shouldDirty: true })
                          }
                        />
                      </div>
                    </div>
                    ...
                    <div className="border-t pt-4 space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            setValue("notifications.quiet_hours_enabled", checked, { shouldDirty: true })
                          }
                        />
                      </div>
                        ...
                        <>
                          <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-2">
                              ...
                              <Input
                                ...
                                type="time"
                                {...register("notifications.quiet_hours_start")}
                                disabled={!canEdit}
                              />
                            </div>
                            <div className="space-y-2">
                          ...
                          {!validateQuietHours() && (
                            <Alert variant="destructive">
                              <AlertTriangle className="h-4 w-4" />
                              <AlertDesc>
                                Quiet hours start and end times are too close together (minimum 1 hour required)
                              </AlertDesc>
                            </Alert>
                          )}
                          <div className="flex items-center gap-2">
                      ...
                      <div className="space-y-0.5">
                        ...
                        {data && (
                          <p className="text-xs text-muted-foreground">
                            Current: {data.security?.require_mfa ? "Enabled" : "Disabled"}
                          </p>
                        )}
                      </div>
                      <Switch
      ...
      <Dialog open={mfaConfirmOpen} onOpenChange={setMfaConfirmOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Enabling MFA will require all users to set up multi-factor authentication on their next login.
              This action cannot be easily undone.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button variant="outline" onClick={() => setMfaConfirmOpen(false)}>
              Cancel
            </Button>
            <Button onClick={confirmMfaToggle}>
              Confirm Enable MFA
            </Button>
          </DialogFooter>
        </DialogContent>
      ...
      <SettingsImportDialog open={importDialogOpen} onOpenChange={setImportDialogOpen} onSuccess={() => { refetch(); }} />
