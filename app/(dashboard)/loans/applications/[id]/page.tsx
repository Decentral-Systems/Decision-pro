...
function LoanApplicationDetailContent() {
  ...
  const { data: statusHistoryData, isLoading: statusHistoryLoading } =
    useLoanApplicationStatusHistory(applicationId, 100);
  const updateStatusMutation = useUpdateLoanApplicationStatus();
  const { data: approvalWorkflowData } =
    useApprovalWorkflowByApplication(applicationId);
  const { data: disbursementsData } = useLoanDisbursements(applicationId);
  const { data: repaymentScheduleData } =
    useLoanRepaymentSchedule(applicationId);
  const { data: creditScoreHistoryData } = useCreditScoreHistory(
    applicationId,
    50
  );
  ...
  const statusHistory =
    statusHistoryData?.data?.history || statusHistoryData?.history || [];
        ...
        <Card>
          <CardContent className="space-y-4 py-8">
            ...
            <div className="flex justify-center">
              <Button
                variant="outline"
                onClick={() => navigateTo("/loans/applications")}
              >
        ...
        <div className="flex items-center space-x-2">
          ...
          {application.application_status === "approved" && (
            <Button
              ...
              onClick={() => {
                navigateTo(
                  `/loans/disbursements/create?application_id=${applicationId}`
                );
              }}
            >
          ...
          {application.application_status === "active" && (
            <Button
              ...
              onClick={() => {
                navigateTo(
                  `/loans/repayments/record?application_id=${applicationId}`
                );
              }}
            >
              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  ...
                  {customerPreviousLoansData?.data?.items &&
                    customerPreviousLoansData.data.items.length > 0 && (
                      <div className="mt-3 border-t pt-3">
                        ...
                        <div className="max-h-32 space-y-1.5 overflow-y-auto">
                          {customerPreviousLoansData.data.items
                            ...
                            .map((loan: any, idx: number) => (
                              <div
                                key={idx}
                                className="flex cursor-pointer items-center justify-between rounded bg-background p-1.5 text-xs transition-colors hover:bg-muted"
                                onClick={() =>
                                  navigateTo(
                                    `/loans/applications/${loan.id || loan.loan_id}`
                                  )
                                }
                              >
                                <div className="min-w-0 flex-1">
                                  <div className="truncate font-medium">
                                    {loan.application_number ||
                                      `Loan #${loan.id || loan.loan_id}`}
                                  </div>
                                  <div className="text-xs text-muted-foreground">
                                    {loan.loan_type?.replace(/_/g, " ")} •{" "}
                                    {loan.application_status?.replace(
                                      /_/g,
                                      " "
                                    )}
                                  </div>
                        ...
                        {customerPreviousLoansData.data.items.filter(
                          (loan: any) => loan.id !== applicationId
                        ).length > 5 && (
                          <Button
                            variant="ghost"
                            size="sm"
                            ...
                            onClick={() => {
                              navigateTo(
                                `/loans/applications?customer_id=${application.customer_id}`
                              );
                            }}
                          >
                            View All (
                            ...
                            <div className="space-y-1.5">
                              <div className="flex items-center justify-between text-xs">
                                ...
                                <div className="flex items-center space-x-2">
                                  ...
                                  <span className="min-w-[45px] text-right text-xs font-medium">
                                    {(
                                      application.default_probability * 100
                                    ).toFixed(1)}
                                    %
                                  </span>
                                </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {application.loan_type?.replace(/_/g, " ")}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">
                ...
                <div className="space-y-4">
                  ...
                  {application.one_third_salary_check !== undefined && (
                    <div className="flex items-center justify-between">
                      ...
                      <Badge
                        className={
                          application.one_third_salary_check
                            ? "bg-green-500"
                            : "bg-red-500"
                        }
                      >
                  ...
                  {application.debt_to_income_ratio !== undefined && (
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {(application.debt_to_income_ratio * 100).toFixed(2)}%
                      </span>
                    </div>
                  )}
                  {application.compliance_violations &&
                    application.compliance_violations.length > 0 && (
                      <div>
                        <span className="text-muted-foreground">
                          Violations:
                        </span>
                        <ul className="mt-2 list-inside list-disc">
                          {application.compliance_violations.map(
                  ...
                  <div className="space-y-4">
                    {statusHistory.map((entry: any, index: number) => {
                      ...
                      return (
                        <div
                          key={index}
                          className={`flex items-start space-x-4 border-l-2 ${getStatusColor(entry.new_status)} relative pl-4`}
                        >
                          <div className="absolute -left-2.5 top-0 rounded-full bg-background p-1">
        ...
        <TabsContent value="credit-history" className="space-y-4">
          ...
          >
            <Card>
              ...
              <CardContent>
                {creditScoreHistoryData?.data?.history &&
                creditScoreHistoryData.data.history.length > 0 ? (
                  <div className="space-y-6">
                    {/* Trend Indicator */}
                      ...
                      <div className="flex items-center justify-between rounded-lg bg-muted p-4">
                        <div>
                          ...
                          <div className="mt-1 flex items-center space-x-2">
                            ...
                            {creditScoreHistoryData.data.trend_change !== 0 && (
                              <span
                                className={`text-sm ${creditScoreHistoryData.data.trend_change > 0 ? "text-green-600" : "text-red-600"}`}
                              >
                                (
                                {creditScoreHistoryData.data.trend_change > 0
                                  ? "+"
                                  : ""}
                                {creditScoreHistoryData.data.trend_change.toFixed(
                                  1
                                )}{" "}
                                points)
                              </span>
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-2xl font-bold">
                            {creditScoreHistoryData.data.current_score?.toFixed(
                              0
                            ) || "N/A"}
                          </p>
                        </div>
                    ...
                    {creditScoreHistoryData.data.history.some(
                      (r: any) => r.risk_level
                    ) && (
                      <div>
                        <h3 className="mb-4 text-lg font-semibold">
                        ...
                        <ResponsiveContainer width="100%" height={200}>
                          <BarChart
                            data={Object.entries(
                              creditScoreHistoryData.data.history.reduce(
                                (acc: any, record: any) => {
                                ...
                                <TableRow key={idx}>
                                  ...
                                  <TableCell>
                                    <Button
                                      ...
                                      onClick={() => {
                                        if (record.loan_id) {
                                          navigateTo(
                                            `/loans/applications/${record.loan_id}`
                                          );
                                        }
                                      }}
                                    >
                                  ...
                                  <TableCell>
                                    {record.default_probability
                                      ? `${(record.default_probability * 100).toFixed(1)}%`
                                      : "N/A"}
                                  </TableCell>
                                  <TableCell>
                                    {getStatusBadge(
                  ...
                  <div className="py-8 text-center text-muted-foreground">
                    ...
                    <p className="mt-2 text-sm">
                      Credit score history will appear here once applications
                      are processed
                    </p>
                  </div>
                )}
          ...
          >
            <div className="grid gap-4 md:grid-cols-2">
              <Card>
                ...
                <CardContent>
                  {approvalWorkflowData?.data?.workflow ||
                  approvalWorkflowData?.data ? (
                    <div className="space-y-3">
                      ...
                      <Button
                        ...
                        onClick={() => {
                          navigateTo(
                            `/loans/approvals?application_id=${applicationId}`
                          );
                        }}
                      >
                        View Full Workflow
              ...
              <Card>
                ...
                <CardContent>
                  {disbursementsData?.data?.disbursements &&
                  disbursementsData.data.disbursements.length > 0 ? (
                    <div className="space-y-3">
                      ...
                      <Button
                        ...
                        onClick={() => {
                          navigateTo(
                            `/loans/disbursements?application_id=${applicationId}`
                          );
                        }}
                      >
              ...
              <Card>
                ...
                <CardContent>
                  {repaymentScheduleData?.data?.schedule ? (
                    <div className="space-y-3">
                      {repaymentScheduleData.data.schedule.payments &&
                        repaymentScheduleData.data.schedule.payments.length >
                          0 && (
                          <>
                            <div className="text-sm font-medium">
                              {
                      ...
                      {repaymentScheduleData.data.payments &&
                        repaymentScheduleData.data.payments.length > 0 && (
                          <div className="mt-2 text-sm font-medium">
                            {repaymentScheduleData.data.payment_count}{" "}
                            Payment(s) Recorded
                          </div>
                        )}
                      <Button
                        ...
                        onClick={() => {
                          navigateTo(
                            `/loans/repayments?application_id=${applicationId}`
                          );
                        }}
                      >
                        View Full Schedule
                    ...
                    {application.application_status === "in_collection" ? (
                      <>
                        ...
                        <Button
                          ...
                          onClick={() => {
                            navigateTo(
                              `/loans/collections?application_id=${applicationId}`
                            );
                          }}
                        >
