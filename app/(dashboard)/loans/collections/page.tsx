...
import {
  useOverdueLoans,
  useInitiateCollectionWorkflow,
  useRecordCollectionAction,
  useCollectionEffectiveness,
  useCollectionWorkload,
  ...
  const handleRecordAction = async () => {
    ...
    try {
      await recordActionMutation.mutateAsync({
        ...
        promise_amount: actionFormData.promise_amount
          ? parseFloat(actionFormData.promise_amount)
          : null,
      });
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="in_person_visit">
                        In-Person Visit
                      </SelectItem>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      setActionFormData({
                        ...actionFormData,
                        customer_response: e.target.value,
                      })
                    }
                ...
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    onChange={(e) =>
                      setActionFormData({
                        ...actionFormData,
                        promise_to_pay: e.target.checked,
                      })
                    }
                    className="rounded"
                  />
              ...
              {effectivenessLoading ? (
                ...
                <>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {formatCurrency(effectivenessData.total_collected || 0)}{" "}
                    collected
                  </p>
                </>
              )}
            ...
            <CardContent>
              {workloadLoading ? (
                ...
                <>
                  ...
                  <p className="text-xs text-muted-foreground">
                    {workloadData.average_cases_per_officer || 0} cases per
                    officer
                  </p>
                </>
              )}
          ...
          <div className="flex items-center space-x-2">
            <Input
              ...
              onChange={(e) =>
                setFilters({
                  ...filters,
                  days_overdue_min: e.target.value
            ...
            <Input
              ...
              onChange={(e) =>
                setFilters({
                  ...filters,
                  days_overdue_max: e.target.value
                    ? parseInt(e.target.value)
                    : undefined,
                })
              }
      ...
      >
        <Card>
          <CardHeader>
            ...
            <CardDescription>Loans requiring collection action</CardDescription>
          </CardHeader>
          <CardContent>
            {isLoading ? (
                    ...
                    <TableRow key={loan.loan_application_id}>
                      ...
                      <TableCell>
                        <Button
                          ...
                          variant="outline"
                          onClick={() =>
                            handleInitiateWorkflow(loan.loan_application_id)
                          }
